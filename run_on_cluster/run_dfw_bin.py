                ...
                if sub_bin.material == "SS":
                    if sub_bin.mode == sub_bin_mode:
                        ...
                        try:
                            ...
                            output_file = f"results_{scenario_name}/wall_bin_{bin_index}_sub_bin_dfw.json"
                            
                            os.makedirs("results_"+str(scenario_name), exist_ok=True)
                            with open(output_file, "w") as f:
                                json.dump(wall_subbin_data, f, indent=4)

                            print(f"Completed wall bin {bin_index}, dfw")

                        except Exception as e:
                            print(f"Failed to process wall bin {bin_index}, dfw: {e}")
