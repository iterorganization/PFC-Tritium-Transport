...
if __name__ == '__main__':
    ...
    inner_data, outer_data, data_div = read_div_solps('raw_data/sol_simus/solps_data/raised_SP_solps/fp_tg_i.123102.dat','raw_data/sol_simus/solps_data/raised_SP_solps/fo_tg_o.123102.dat','raw_data/sol_simus/solps_data/raised_SP_solps/ld_tg_i.123102.dat','raw_data/sol_simus/solps_data/raised_SP_solps/ld_tg_o.123102.dat','raw_data/sol_simus/inner_target.shot123102.run1.dat','raw_data/sol_simus/outer_target.shot123102.run1.dat')
    # np.savetxt('inner.txt', inner_data)

    # create bins for fluxes
    div_z_start, div_r_start, div_z_end, div_r_end = load_geometry('old_binning_funcs/RISPDivpanelscorners.txt', wall=False)
    z_coord_start, r_coord_start, z_coord_end, r_coord_end = load_geometry("old_binning_funcs/FWpanelcorners.txt")
