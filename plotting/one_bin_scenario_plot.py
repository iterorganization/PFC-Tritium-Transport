...
from iter_bins.make_iter_bins import Div_bins, total_nb_bins, total_fw_bins, FW_bins
import math
import numpy as np
...
# open results file
with open("results_do_nothing/wall_bin_1_sub_bin_shadowed.json", "r") as file:
...
def get_bin_data(data: list, bin_index: int) -> dict:
    ...
    for i in data:
        if i in (18,65):
            ...
            if i["parent_bin_index"] == bin_index:
                return i
