...
ion_flux_tot = np.full(62,1.0e+18)
atom_flux_tot = np.full(62,0.7e+19)
E_ion_tot = np.full(62,50) # eV
E_atom_tot = np.full(62,200)
alpha_ion_tot = np.full(62,45.0)
alpha_atom_tot = np.full(62,60.0)
heat_tot = np.full(62,0.0)
