...
benchmark_no_glow_scenario = Scenario(pulses=[fp,icwc,risp5,risp1,icwc,risp5,risp1_longer_wait])
...
clean_every_5_scenario = Scenario(pulses=[fp,risp6,icwc_long,fp,risp6,icwc_long,gdc])
...
clean_every_2_scenario = Scenario(pulses=[fp,risp3,icwc_short,fp1_end_day,fp1_start_day,risp3,icwc_short_end_day, fp, risp3, icwc_short, fp1_end_day, fp1_start_day, risp3, icwc_short_end_day, fp, risp6, icwc_long,gdc])