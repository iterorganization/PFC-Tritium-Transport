...
row_files = [
    ...
    '/home/ITER/dunnelk/kaelyn-MHIMS/flux_data/wetted_rows_data/row_4_flat_top.csv',
    ...
    '/home/ITER/dunnelk/kaelyn-MHIMS/flux_data/wetted_rows_data/row_7_flat_top.csv',
    ...
    '/home/ITER/dunnelk/kaelyn-MHIMS/flux_data/wetted_rows_data/row_14_flat_top.csv',
    ...
    '/home/ITER/dunnelk/kaelyn-MHIMS/flux_data/wetted_rows_data/row_17_flat_top.csv',
...
for idx in range(len(rows)):
    ...
    if len(bin_centers[peaks])>1 and idx != 17: # 3 bin-bins
        ...
        if idx == 13 or idx == 14: # separating out port rows 
